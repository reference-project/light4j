...
public class MoneyRequestsSendGetHandlerTest {
    ...
    public void testMoneyRequestsSendGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/money-requests/send?fromDate=LQIRiokCAslsXptPDSW&toDate=cSHJcwMhVrWxoQYQRCwgWyQdyxxfp&maxResponseItems=5&offset=34&sortBy=vGbDU&orderBy=CrrlLvjLlzQhdkThlLSHhvwdh&sourceMoneyRequestId=lQEmmvFNClAfKRqUFfPxXeo&referenceNumber=cRuivnmRhzC";
