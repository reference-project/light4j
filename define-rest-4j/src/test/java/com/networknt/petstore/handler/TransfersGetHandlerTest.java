...
public class TransfersGetHandlerTest {
    ...
    public void testTransfersGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/transfers?fromDate=eiRFmsUWPBFOknfIG&toDate=nQKvbUzo&maxResponseItems=78&offset=25&sortBy=vGGnQfnujLEweQhfavbeEWchCReo&orderBy=GbbDogMlfj&sourceTransferId=CJAkzgPYqLeOjlCchfLtvYJEDEglOeinUXxfCtQVmCpgzFBbwCZbcMyg&referenceNumber=hbqOig";
