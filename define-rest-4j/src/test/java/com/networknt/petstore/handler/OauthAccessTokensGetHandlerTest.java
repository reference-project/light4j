...
public class OauthAccessTokensGetHandlerTest {
    ...
    public void testOauthAccessTokensGetHandlerTest() throws ClientException {
        ...
        try {
            ...
            request.getRequestHeaders().put(new HttpString("grantType"), "rZRBYgYpznEluGhLgfPW");
            request.getRequestHeaders().put(new HttpString("grantRequest"), "RQXSumQLvqWAWbQxoxXCDi");
