...
public class ContactsGetHandlerTest {
    ...
    public void testContactsGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/contacts?maxResponseItems=10&fromLastUpdatedDate=OWpJmY&offset=96&sortBy=PsFeIIAueaIOCVEhmJUfmphKY&orderBy=KYMKgNbZQeIK";
