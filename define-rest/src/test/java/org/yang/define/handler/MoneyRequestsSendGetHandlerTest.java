...
public class MoneyRequestsSendGetHandlerTest {
    ...
    public void testMoneyRequestsSendGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/money-requests/send?fromDate=IfOaZqdGwtCMALjZTSmReb&toDate=yieDMLoDw&maxResponseItems=72&offset=85&sortBy=fodyMsDK&orderBy=ztsLk&sourceMoneyRequestId=XNJUJybVDeoiGMOEQnqhUTqBnvsvSzAwbPSdywvRq&referenceNumber=EbDswarZXJAYt";
