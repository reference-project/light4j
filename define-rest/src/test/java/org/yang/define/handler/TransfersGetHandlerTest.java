...
public class TransfersGetHandlerTest {
    ...
    public void testTransfersGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/publicapi/api/v2/transfers?fromDate=dNmZoPjDDKmIndwTBjaNkgGPWt&toDate=MhxAWfS&maxResponseItems=36&offset=31&sortBy=TMlNoHIYzSr&orderBy=vRqDCyJEPbuelzZapngQPSE&sourceTransferId=OOuNJrcLVHLIiFyeGObMZFNxHoAJqCjXURCHHTgcBpVTAowdpzuZLcbzSxxxfl&referenceNumber=tAsVxnhP";
